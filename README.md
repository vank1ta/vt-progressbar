...
![VT Developmtn's GitHub Project VT Dev](https://i.imgur.com/NiYvAUl.png)

  -  > fix(network spam): Add DoesEntityExist checks

  -  > Made with NoPixel 3.5 style
...
### Installation
- > Change the resource from **vt-progressbar** to **progressbar** and replace your folder **[standalone]**

# License
    
    Copyright (C) 2022 VT Developmtn's Team.
